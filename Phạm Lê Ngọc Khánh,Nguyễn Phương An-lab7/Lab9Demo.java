...
public class Lab9Demo {
    public static void main(String[] args){
        ...
        System.out.println("\n--- Scenario 1: ---");
        User student1 = UserFactory.createUser("N0202", "nhat@gmail.com", "Nhat", "DS", "1");
        User student2 = UserFactory.createUser("S002", "an@gmail.com", "An", "CS", "3");
        User staff1   = UserFactory.createUser("T001", "tien@gmail.com", "Tien", "CS", "Lecturer");
        User staff2   = UserFactory.createUser("T002", "thuy@gmail.com", "Thuy", "IT", "Manager");
        ...
        System.out.println("\n--- Scenario 4: ---");
        try {
            User duplicate = UserFactory.createUser( "S001", "dup@gmail.com", "Dup", "CS", "1");
